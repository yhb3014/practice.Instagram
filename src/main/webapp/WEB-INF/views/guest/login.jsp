		...
		<sec:authorize access="not authenticated">
			...
			<div style="position: absolute; text-align: center; right: 34%; width: 450px; top: 200px; font-size: 1.5em; position: absolute;">
				...
				<form method="post" action="/loginProc">
					...
					<div>
						<button type="submit" class="btn" style="margin-left: 20%; margin-top: 15px; width: 300px; background-color: #8fd3ff; border: 1px solid transparent;">로그인</button>
					</div>
				</form>
				...
				<div style="text-align: center; right: 15%; top: 475px; position: absolute;">

					<a href="/guest/register" class="btn btn-dark" style="font-size: 15px;">가입하기</a>
