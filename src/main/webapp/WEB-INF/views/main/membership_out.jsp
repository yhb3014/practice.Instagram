...
<body>
	...
	<br /> <br /> <span>${username} 님, 안녕하세요!</span> <br /> <span>계정을
			삭제하려고 하신다니 아쉽습니다.</span> <br /> <span>잠시 활동을 쉬고 싶으시다면 대신 Instagram
			계정을 </span> <a href="/main/user/secret_user">일시적으로 비활성화</a><span>할 수 있습니다.</span>
		<hr />
		<form action="/main/real_out" method="post">
				<br/> <span><b>계정을 삭제하시는 이유가 무엇인가요?</b></span><br/> 
				<input type = "hidden" value="${currentid}" name="uid"/> 
			<div>
			...
			<br/><br/><span><b>계속하시려면 비밀번호를 다시 입력하세요.</b></span><br/>
			<input type="password" name="pswd" class="form-control" style="width: 300px;"><br/><br/>
			<a href="#">비밀번호를 잊으셨나요?</a><br/><br/><span>아래 버튼을 누르면 사진, 댓글, 좋아요, 친구관계를 포함한
			모든 데이터가 영구적으로 삭제되어 복구할 수 없게 됩니다.</span><br/><br/>
			
			<button type="submit" onclick="return confirm('계정을 삭제 하시겠습니까?')" style="background-color: red; color: white;" >
			내 계정 영구삭제</button>
