	...
	<div id="contents">
		<div class="search">
			<form action="/main/search" class="form-inline my-2 my-lg-0" autocomplete="off">
				<input class="form-control mr-sm-2" type="search" name="word" placeholder="Search" aria-label="Search" style="margin-top: 10px; width: 350px; float: left;">
				<button class="btn btn-outline-success my-2 my-sm-0" style="margin-top: 10px; margin-left: 5px;" type="submit">
					<span class="glyphicon glyphicon-search" style="margin-top: 7px; margin: 2px;"></span>
				</button>
			</form>
		</div>
					...
					<c:forEach var="u" items="${find_user}">
						<div class="f">
							...
							<div class="userid_txt">
								<a href="/main/user/${u.id}" style="font-size: 18px; color: black; margin-left: 9px;">${u.userId}</a>
							</div>
						</div>
					</c:forEach>
