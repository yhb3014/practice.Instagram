...
public class SecretuserController {
	...
	@ResponseBody
	private boolean sercret_view(@PathVariable int id) throws Exception{
	...
	@ResponseBody
	private int sercret_insert(@PathVariable int id) throws Exception{
	...
	@ResponseBody
	private int sercret_delete(@PathVariable int id) throws Exception{
